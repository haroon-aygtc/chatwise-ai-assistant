...
const RolesPermissions = () => {
  ...
  const { permissionCategories, isLoadingPermissions } =
        ...
        <div className="flex justify-between items-center p-6 border-b">
          ...
          <div className="flex items-center gap-3">
            ...
            {activeTab === "roles" && (
              ...
              >
                <label
                  htmlFor="edit-system-roles"
                  className="text-sm font-medium cursor-pointer"
                >
                  {canEditSystemRoles
                    ? "System roles editable"
                    : "System roles locked"}
                </label>
                <div
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange}>
          ...
          <TabsContent value="roles" className="p-6">
            {isLoading ? (
              ...
              <div
                className="text-center py-12 bg-muted/20 rounded-lg border border-dashed"
                key="no-roles-found"
              >
            ...
            <div className="bg-card rounded-lg border">
              <div className="border-b p-4">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  These permissions can be assigned to roles to control access
