          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => updateProviderSpecificState("organization", e.target.value)}
                className="col-span-3"
        ...
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                value={modelId}
                onValueChange={(value) => onModelIdChange({ target: { value } } as any)}
              >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => updateProviderSpecificState("topK", parseInt(e.target.value))}
                className="col-span-3"
                min={1}
                max={100}
              />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) => updateProviderSpecificState("task", value)}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="text2text-generation">Text-to-Text Generation</SelectItem>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3 flex items-center">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateProviderSpecificState("waitForModel", checked)}
                />
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3 flex items-center">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateProviderSpecificState("safePrompt", checked)}
                />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => updateProviderSpecificState("repetitionPenalty", parseFloat(e.target.value))}
                className="col-span-3"
                min={1.0}
                max={2.0}
              />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) => updateProviderSpecificState("routeType", value)}
              >
