...
export const FollowUpManager = () => {
  ...
  const handleToggleStatus = async (id: string) => {
    try {
      ...
      setFollowUps(
        followUps.map((fu) => (fu.id === id ? updatedSuggestion : fu)),
      );
  ...
  const handleAddOrUpdateSuggestion = async () => {
    ...
    try {
      if (isEditing && currentSuggestion.id) {
        ...
        setFollowUps(
          followUps.map((fu) => (fu.id === updated.id ? updated : fu)),
        );
        toast({
        ...
        const created = await createSuggestion(
          currentSuggestion as Omit<FollowUpSuggestion, "id">,
        );
        ...
        <TabsContent value="suggestions" className="space-y-4 pt-4">
          <div className="flex justify-between items-center">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Manage automated follow-up suggestions that appear after AI
                responses
              </p>
            </div>
            <Button
          ...
          {showAddForm && (
            <Card>
              <CardHeader>
                <CardTitle>
                  {isEditing ? "Edit" : "Add"} Follow-Up Suggestion
                </CardTitle>
                <CardDescription>
                  {isEditing
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="suggestion-active">
                        ...
                        <TableRow key={followUp.id}>
                          ...
                          <TableCell>
                            <Switch
                              ...
                              onCheckedChange={() =>
                                handleToggleStatus(followUp.id)
                              }
                            />
                          </TableCell>
                          <TableCell>
                            <div className="flex space-x-2">
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => handleEditSuggestion(followUp)}
                              >
                              ...
                              <Button
                                ...
                                size="icon"
                                onClick={() =>
                                  handleDeleteSuggestion(followUp.id)
                                }
                              >
          ...
          <div className="flex justify-between items-center">
            <div className="space-y-1">
              <h3 className="text-2xl font-semibold">
                Branching Response Formats
              </h3>
              <p className="text-sm text-muted-foreground">
                Create conversation flows with branching paths based on user
                responses
              </p>
            </div>
            <Button>
              ...
              <>
                {branchingFlows.map((flow) => (
                  <Card
                    key={flow.id}
                    className={
                      selectedSuggestion === flow.id ? "border-primary" : ""
                    }
                  >
                    <CardHeader>
                    ...
                    <CardFooter className="flex justify-between">
                      ...
                      <Button size="sm">
                        <ArrowRightFromLine className="mr-2 h-4 w-4" /> View
                        Flow
                      </Button>
                    </CardFooter>
                  </Card>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center p-6 text-center">
                ...
                <h3 className="text-lg font-semibold">
                  No Branching Flows Yet
                </h3>
                <p className="text-muted-foreground mb-4">
                  Create your first flow to start building branching
                  conversation paths
                </p>
                <Button>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label>
                    Use AI to automatically generate relevant follow-ups
                  </Label>
                </div>
                <p className="text-sm text-muted-foreground">
                  When enabled, the system will dynamically generate contextual
                  follow-up suggestions based on conversation content
                </p>
              </div>
              <Separator />
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, branchingEnabled: checked })
                    }
                  />
                  <Label>Allow conversation flows with multiple paths</Label>
                </div>
                <p className="text-sm text-muted-foreground">
                  When enabled, follow-up suggestions can lead to different
